        ...
        <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    ...
                    >
                        My Name is Alex. <br/>
                        I am <span class="rounded-md text-amber-600">The Codeholic</span>
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        I am a developer with 10+ years of experience. <br/>
                        I love shaping my knowledge to others, that's why I created a
                        <a
                            class="text-primary font-bold no-underline underline-offset-2 decoration-2 decoration-primary"
                            href="https://www.youtube.com" target="_blank">YouTube Channal</a>. <br/>
                    </p>
