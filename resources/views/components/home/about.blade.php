            ...
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="mt-10 lg:mt-0">
                    ...
                    <p class="text-base dark:text-gray-400 mb-8">
                        ...
                        During my career I have working on various types of projects with various technologies,
                        but very often I feel that I am a junior developer who just started coding. <br />
                    </p>
                    <p class="text-base dark:text-gray-400 mb-8">
                        In 2018 I decided to create a YouTube channel and share my knowledge. My channel is most focused on
                        <span class="text-amber-500 font-bold">PHP</span> and <span class="text-amber-500 font-bold">JavaScript</span>. <br />
                        My content is mostly focused on practical examples and project. <br />
                    </p>
