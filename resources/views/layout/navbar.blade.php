            ...
            <div class="pr-4 w-60 max-w-full">
                <a href="/" class="w-full flex items-center py-2">
                    ...
                    <img src="{{ url('/img/logo-white.png') }}"
                         alt="logo"
                         class="w-[48px] lg:w-[64px] hidden inline-block dark:inline-block"
                    />
            ...
            <div class="flex px-4 justify-end items-center w-full">
                <div class="">
                    <x-layout.navbar-hamburger @click="navbarOpen = !navbarOpen"
                                               x-bind:class="nabvarOpen && 'navbarToggleActice'"></x-layout.navbar-hamburger>
                    ...
                    >
                        <ul class="block lg:flex lg:item-center">
